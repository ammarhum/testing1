...
const ASSETS_TO_CACHE = [
  ...
  '/testing/icons/icon-72x72.png',
  '/testing/icons/icon-96x96.png',
  '/testing/icons/icon-128x128.png',
  '/testing/icons/icon-144x144.png',
  '/testing/icons/icon-152x152.png',
  '/testing/icons/icon-192x192.png',
  '/testing/icons/icon-384x384.png',
  '/testing/icons/icon-512x512.png'
];
